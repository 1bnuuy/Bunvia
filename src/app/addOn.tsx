...
export const Star = ({ size, t, l }: AddOnTypes) => {
  return (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
      style={{ top: `${t}%`, left: `${l}%` }}
      className="fill-heading dark:fill-heading-dark pointer-events-none absolute z-0"
    >
      <path
...
export const StarDouble = ({ size, t, l }: AddOnTypes) => {
  return (
    <svg
      width={size}
      height={size}
...
export const StarOutline = ({ size, t, l }: AddOnTypes) => {
  return (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
      style={{ top: `${t}%`, left: `${l}%` }}
      className="pointer-events-none absolute z-0 fill-none opacity-30"
    >
      <path
        d="M12 3C12 7.97056 7.97056 12 3 12C7.97056 12 12 16.0294 12 21C12 16.0294 16.0294 12 21 12C16.0294 12 12 7.97056 12 3Z"
