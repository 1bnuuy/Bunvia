...
import { Star, Star2 } from "@/components/Star";
...
export default function Home() {
  return (
    <section className="dark:bg-primary-dark grid-background bg-primary h-dvh w-screen overflow-x-hidden overflow-y-scroll pt-8 transition max-lg:pb-25 md:pt-15 lg:px-30">
      <div className="text-heading dark:text-heading-dark relative z-10 flex h-full max-h-[600px] flex-col items-center justify-center gap-3">
        <h1 className="text-6xl z-10 font-bold tracking-widest md:text-7xl">
          BUNVIA
        </h1>

        <p className="text-subtext z-10 dark:text-subtext-dark text-xl max-sm:text-lg">
...
<div className="flex gap-4">
        <MotionLink
          ...
          whileTap="tap"
          href="todolist"
          className="z-10 bg-heading select-none dark:text-primary-dark dark:bg-heading-dark text-primary flex items-center gap-2 rounded-md px-5 py-2 text-xl"
        >
          <span>Get started</span>
          <FontAwesomeIcon icon={faWandMagicSparkles} />
        </MotionLink>

        <motion.button variants={btnScale}
          initial="initial"
          whileHover="hover"
          whileTap="tap"
          className="z-10 border-2 border-heading select-none dark:text-heading-dark dark:border-heading-dark cursor-pointer text-heading flex items-center gap-2 rounded-md px-5 py-2 text-xl">
          bnuuy
        </motion.button>
        ...
        <div className="absolute size-full">
          <Star size={40} t={16.6667} l={33.3333} />
          <Star size={25} t={91.6667} l={66.6667} />
          <Star size={30} t={8.3333} l={8.3333} />
          <Star size={20} t={110} l={25} />
          <Star size={50} t={75} l={92.3333} />

          <Star2 size={50} t={20} l={75} />
          <Star2 size={30} t={0} l={50} />
          <Star2 size={40} t={75} l={15} />
        </div>
        <span className="bg-heading dark:bg-heading-dark pointer-events-none absolute bottom-0 -z-10 size-[350px] blur-[200px]" />
      </div>
