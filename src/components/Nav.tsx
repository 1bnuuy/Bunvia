...
export default function Nav() {
  ...
  const availablePaths = ["/", "/todolist", "/dictionary", "/analytics", "/auth"];
          ...
          >
            <AnimatePresence>
              <motion.div
                ...
                initial="initial"
                key="themeButton"
                className="border-accent dark:border-accent-dark relative flex cursor-pointer items-center justify-center rounded-md border-2"
                onClick={ThemeToggle}
              >
                <span
